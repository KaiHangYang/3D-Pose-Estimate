...
bool CCameraDS::OpenCamera(int nCamID, bool bDisplayProperties, int nWidth, int nHeight)
{
	...
	CoInitialize(NULL);
	// Create the Filter Graph Manager.（DirectShow） // Create a GraphBuilder
	...
	// Query for interfaces( MediaControl, MediaEvent)
	...
	// the difference of RGB24 and RGB32 is RGB32 has alpha channel
	...
	// add the pins between the filters
